...
!!! note
    **Assessments need approval** cannot be disabled (neither on the product nor on the
    product group) while assessments are still pending approval. Approve, reject or delete
    the pending assessments first.
