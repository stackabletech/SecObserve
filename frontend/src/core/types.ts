...
export const ASSESSMENT_STATUS_APPROVED_WITH_EDITS = "Approved with edits";
...
export const ASSESSMENT_STATUS_CHOICES = [
    ...
    { id: ASSESSMENT_STATUS_APPROVED_WITH_EDITS, name: ASSESSMENT_STATUS_APPROVED_WITH_EDITS },
...
export const PURL_TYPE_CHOICES = [
    ...
    { id: "bazel", name: "Bazel" },
    { id: "otp", name: "BEAM/OTP (otp)" },
    { id: "bitbucket", name: "Bitbucket" },
    { id: "bitnami", name: "Bitnami" },
    { id: "brew", name: "Brew" },
    { id: "vcpkg", name: "C/C++ (vcpkg)" },
    { id: "chrome-extension", name: "Chrome (chrome-extension)" },
    { id: "cocoapods", name: "Cocoapods" },
    { id: "composer", name: "Composer" },
    { id: "conan", name: "Conan" },
    { id: "conda", name: "Conda" },
    { id: "cpan", name: "CPAN Perl (cpan)" },
    { id: "cran", name: "CRAN R (cran)" },
    { id: "pub", name: "Dart (pub)" },
    { id: "deb", name: "Debian (deb)" },
    ...
    { id: "julia", name: "Julia" },
    { id: "luarocks", name: "Lua (luarocks)" },
    { id: "maven", name: "Maven" },
    { id: "mlflow", name: "MLflow" },
    { id: "npm", name: "NPM" },
    { id: "nuget", name: "NuGet" },
    { id: "opam", name: "OCaml (opam)" },
    { id: "oci", name: "OCI" },
    { id: "pypi", name: "PyPI" },
    { id: "qpkg", name: "QNX (qpkg)" },
    { id: "rpm", name: "Red Hat (rpm)" },
    { id: "gem", name: "Ruby (gem)" },
    { id: "cargo", name: "Rust (cargo)" },
    { id: "swid", name: "SWID" },
    { id: "swift", name: "Swift" },
    { id: "vscode-extension", name: "Visual Studio Code (vscode-extension)" },
    { id: "yocto", name: "Yocto" },
];

export const get_purl_type_name = (purl_type: string): string =>
    PURL_TYPE_CHOICES.find((choice) => choice.id === purl_type)?.name ?? purl_type;
