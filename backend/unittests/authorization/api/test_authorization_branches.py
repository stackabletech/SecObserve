...
class TestAuthorizationBranches(TestAuthorizationBase):
    ...
    def _test_authorization_branches(self):
        ...
        expected_data = "{'id': 1, 'name_with_product': 'db_branch_internal_dev (db_product_internal)', 'active_critical_observation_count': 0, 'active_high_observation_count': 0, 'active_medium_observation_count': 0, 'active_low_observation_count': 0, 'active_none_observation_count': 0, 'active_unknown_observation_count': 0, 'forbidden_licenses_count': 0, 'review_required_licenses_count': 0, 'unknown_licenses_count': 0, 'allowed_licenses_count': 0, 'ignored_licenses_count': 0, 'security_gate_passed': True, 'name': 'db_branch_internal_dev', 'is_default_branch': True, 'last_import': None, 'housekeeping_protect': False, 'purl': '', 'cpe23': '', 'osv_linux_distribution': '', 'osv_linux_release': '', 'product': 1}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
        ...
        expected_data = "{'id': 4, 'name_with_product': 'string (db_product_internal)', 'security_gate_passed': None, 'name': 'string', 'is_default_branch': False, 'last_import': None, 'housekeeping_protect': False, 'purl': '', 'cpe23': '', 'osv_linux_distribution': '', 'osv_linux_release': '', 'product': 1}"
        self._test_api(
            APITest(
                "db_internal_write",
                "post",
