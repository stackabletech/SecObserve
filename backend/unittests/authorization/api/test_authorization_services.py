...
class TestAuthorizationServices(TestAuthorizationBase):
    ...
    def _test_authorization_services(self):
        expected_data = "{'count': 3, 'next': None, 'previous': None, 'results': [{'id': 1, 'name_with_product': 'db_service_internal_backend (db_product_internal)', 'active_critical_observation_count': 0, 'active_high_observation_count': 0, 'active_medium_observation_count': 0, 'active_low_observation_count': 0, 'active_none_observation_count': 0, 'active_unknown_observation_count': 0, 'forbidden_licenses_count': 0, 'review_required_licenses_count': 0, 'unknown_licenses_count': 0, 'allowed_licenses_count': 0, 'ignored_licenses_count': 0, 'name': 'db_service_internal_backend', 'product': 1}, {'id': 2, 'name_with_product': 'db_service_internal_frontend (db_product_internal)', 'active_critical_observation_count': 0, 'active_high_observation_count': 0, 'active_medium_observation_count': 0, 'active_low_observation_count': 0, 'active_none_observation_count': 0, 'active_unknown_observation_count': 0, 'forbidden_licenses_count': 0, 'review_required_licenses_count': 0, 'unknown_licenses_count': 0, 'allowed_licenses_count': 0, 'ignored_licenses_count': 0, 'name': 'db_service_internal_frontend', 'product': 1}, {'id': 3, 'name_with_product': 'db_service_external (db_product_external)', 'active_critical_observation_count': 0, 'active_high_observation_count': 0, 'active_medium_observation_count': 0, 'active_low_observation_count': 0, 'active_none_observation_count': 0, 'active_unknown_observation_count': 0, 'forbidden_licenses_count': 0, 'review_required_licenses_count': 0, 'unknown_licenses_count': 0, 'allowed_licenses_count': 0, 'ignored_licenses_count': 0, 'name': 'db_service_external', 'product': 2}]}"
        self._test_api(APITest("db_admin", "get", "/api/services/", None, 200, expected_data))

        expected_data = "{'count': 2, 'next': None, 'previous': None, 'results': [{'id': 1, 'name_with_product': 'db_service_internal_backend (db_product_internal)', 'active_critical_observation_count': 0, 'active_high_observation_count': 0, 'active_medium_observation_count': 0, 'active_low_observation_count': 0, 'active_none_observation_count': 0, 'active_unknown_observation_count': 0, 'forbidden_licenses_count': 0, 'review_required_licenses_count': 0, 'unknown_licenses_count': 0, 'allowed_licenses_count': 0, 'ignored_licenses_count': 0, 'name': 'db_service_internal_backend', 'product': 1}, {'id': 2, 'name_with_product': 'db_service_internal_frontend (db_product_internal)', 'active_critical_observation_count': 0, 'active_high_observation_count': 0, 'active_medium_observation_count': 0, 'active_low_observation_count': 0, 'active_none_observation_count': 0, 'active_unknown_observation_count': 0, 'forbidden_licenses_count': 0, 'review_required_licenses_count': 0, 'unknown_licenses_count': 0, 'allowed_licenses_count': 0, 'ignored_licenses_count': 0, 'name': 'db_service_internal_frontend', 'product': 1}]}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
        ...
        expected_data = "{'id': 1, 'name_with_product': 'db_service_internal_backend (db_product_internal)', 'active_critical_observation_count': 0, 'active_high_observation_count': 0, 'active_medium_observation_count': 0, 'active_low_observation_count': 0, 'active_none_observation_count': 0, 'active_unknown_observation_count': 0, 'forbidden_licenses_count': 0, 'review_required_licenses_count': 0, 'unknown_licenses_count': 0, 'allowed_licenses_count': 0, 'ignored_licenses_count': 0, 'name': 'db_service_internal_backend', 'product': 1}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
