...
class TestAuthorizationConcluded(TestAuthorizationBase):
    ...
    def _test_authorization_concluded_licenses(self):
        expected_data = "{'count': 2, 'next': None, 'previous': None, 'results': [{'id': 1, 'product_data': {'id': 1, 'name': 'db_product_internal', 'is_product_group': False}, 'user_data': {'id': 1, 'username': 'db_admin', 'first_name': '', 'last_name': '', 'full_name': 'db_admin', 'email': '', 'is_active': True, 'is_superuser': True, 'is_external': False, 'setting_theme': 'light', 'setting_list_size': 'medium', 'setting_package_info_preference': 'open/source/insights', 'setting_list_properties': '', 'setting_metrics_timespan': 'Week', 'permissions': [<Permissions.Product_Create: 1104>, <Permissions.Product_Group_Create: 1004>], 'oidc_groups_hash': '', 'is_oidc_user': False, 'date_joined': '2022-12-04T11:09:18.495000+01:00', 'has_password': True}, 'component_name_version': 'internal_component:1.0.0 (npm)', 'manual_concluded_spdx_license_id': '', 'component_purl_type': 'npm', 'component_name': 'internal_component', 'component_version': '1.0.0', 'manual_concluded_license_expression': 'expression', 'manual_concluded_non_spdx_license': '', 'last_updated': '2022-12-15T17:10:35.513000+01:00', 'product': 1, 'manual_concluded_spdx_license': None, 'user': 1}, {'id': 2, 'product_data': {'id': 2, 'name': 'db_product_external', 'is_product_group': False}, 'user_data': {'id': 1, 'username': 'db_admin', 'first_name': '', 'last_name': '', 'full_name': 'db_admin', 'email': '', 'is_active': True, 'is_superuser': True, 'is_external': False, 'setting_theme': 'light', 'setting_list_size': 'medium', 'setting_package_info_preference': 'open/source/insights', 'setting_list_properties': '', 'setting_metrics_timespan': 'Week', 'permissions': [<Permissions.Product_Create: 1104>, <Permissions.Product_Group_Create: 1004>], 'oidc_groups_hash': '', 'is_oidc_user': False, 'date_joined': '2022-12-04T11:09:18.495000+01:00', 'has_password': True}, 'component_name_version': 'external_component:2.0.0 (pypi)', 'manual_concluded_spdx_license_id': '', 'component_purl_type': 'pypi', 'component_name': 'external_component', 'component_version': '2.0.0', 'manual_concluded_license_expression': '', 'manual_concluded_non_spdx_license': 'non spdx', 'last_updated': '2022-12-15T17:10:35.513000+01:00', 'product': 2, 'manual_concluded_spdx_license': None, 'user': 1}]}"
