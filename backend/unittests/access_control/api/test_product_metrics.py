...
class TestAuthorizationProductMetrics(TestAuthorizationBase):
    def test_authorization_metrics(self):
        ...
        expected_data = "{'open_critical': 7, 'open_high': 9, 'open_medium': 11, 'open_low': 13, 'open_none': 15, 'open_unknown': 17, 'open': 19, 'resolved': 21, 'duplicate': 23, 'false_positive': 25, 'in_review': 27, 'not_affected': 29, 'not_security': 31, 'risk_accepted': 33, 'affected': 35}"
        self._test_api(
            APITest(
                "db_admin",
                "get",
        ...
        expected_data = "{'open_critical': 2, 'open_high': 3, 'open_medium': 4, 'open_low': 5, 'open_none': 6, 'open_unknown': 7, 'open': 8, 'resolved': 9, 'duplicate': 10, 'false_positive': 11, 'in_review': 12, 'not_affected': 13, 'not_security': 14, 'risk_accepted': 15, 'affected': 16}"
        self._test_api(
            APITest(
                "db_internal_write",
                "get",
